    ...
    <section className={Style.section} id='about'>
      ...
      <div className='flex items-center w-[74%] h-[55vh] items-center justify-between'>
        <div className='flex flex-col items-center justify-between w-[22%] h-[100%] z-10'>
          <span className={` ' flex w-[80%] h-[3.75rem] bg-[#0a0a0a] z-10 items-center justify-center text-[1.3rem] hover:text-[#04ffc3] euro text-['monument extended'] text-white rounded-[8px] border-2 border-[#04ffce]' ${Style[count%4==0?'active':'']}`} onClick={()=>incrementCount()}>INTRODUCTION</span>
          <span className={` ' flex w-[80%] h-[3.75rem] bg-[#0a0a0a] z-10 items-center justify-center text-[1.3rem] hover:text-[#04ffc3] euro text-['monument extended'] text-white rounded-[8px] border-2 border-[#04ffce]' ${Style[count%4==1?'active':'']}`} onClick={()=>incrementCount()}>EDUCATION</span>
          <span className={` ' flex w-[80%] h-[3.75rem] bg-[#0a0a0a] z-10 items-center justify-center text-[1.3rem] hover:text-[#04ffc3] euro text-['monument extended'] text-white rounded-[8px] border-2 border-[#04ffce]' ${Style[count%4==2?'active':'']}`} onClick={()=>incrementCount()}>SKILLS</span>
          <span className={` ' flex w-[80%] h-[3.75rem] bg-[#0a0a0a] z-10 items-center justify-center text-[1.3rem] hover:text-[#04ffc3] euro text-['monument extended'] text-white rounded-[8px] border-2 border-[#04ffce]' ${Style[count%4==3?'active':'']}`} onClick={()=>incrementCount()}>EXPERIENCE</span>
        </div>
